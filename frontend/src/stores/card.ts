...
export const useCardStore = defineStore('card', () => {
   ...
   *
   * This function initiates the card generation process by sending a request to the API. It sets the generating state, handles the response to populate various properties such as generation ID, recipient, sender, and text/image variants. It also manages error handling and ensures that the generating state is reset after the operation completes. The function defaults to auto-selecting the first text and image variants while including the original text.
   *
